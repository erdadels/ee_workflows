# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 12:02:14 2021

@author: eadelstein
"""

"""
EA-adapted to extact data for a range of years. Removed precip image 
for speed.
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='polygon_id')
    parser.add_argument(
        '-s', '--startyear', help='Start year', type=int, default=2017)
    parser.add_argument(
        '-e', '--endyear', help='End year', type=int, default=2018)
